            ...
            MobileScanner(
              ...
              onDetect: (capture) {
                ...
                if (barcodes.isNotEmpty && barcodes.first.rawValue != null) {
                  ref.read(scanNotifierProvider.notifier).processQrCode(barcodes.first.rawValue!);
                }
              },
            ),
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(LucideIcons.camera, size: 64, color: AppColors.primary),
      ...
      return Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(LucideIcons.checkCircle, color: AppColors.success, size: 64),
          ),
          const SizedBox(height: 24),
          const Text(
            'Attendance Marked!',
      ...
      return Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(LucideIcons.alertCircle, color: AppColors.error, size: 64),
          ),
          const SizedBox(height: 24),
          const Text(
            'Check-in Failed',
