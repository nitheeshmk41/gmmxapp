    ...
    <div className="max-w-3xl space-y-6">
      ...
      <form action={handleUpdate} className="space-y-5">
        <div className="card rounded-2xl p-6 space-y-4">
          ...
          <div>
            <label className="text-xs font-semibold mb-1.5 block" style={{ color: "var(--color-foreground)" }}>Cover Image URL <span className="font-normal" style={{ color: "var(--color-muted-foreground)" }}>(Optional)</span></label>
            <input name="coverImageUrl" type="url" defaultValue={blog.coverImageUrl || ""} placeholder="https://images.unsplash.com/photo-..."
              className="w-full px-4 py-3 rounded-xl text-sm border outline-none"
              style={{ background: "var(--color-background)", borderColor: "var(--color-border)", color: "var(--color-foreground)" }} />
          </div>
